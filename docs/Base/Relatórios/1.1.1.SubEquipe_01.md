...
![Foto das alterações técnicas seguindo a documetnação da UML necessárias para o Diagrama Estático](ExtrasSubEquipe_01/InsumoADS.png)
...
[Diagrama de Sequência V0.1](ExtrasSubEquipe_01/Diagrama_de_Sequencia_V01.pdf)

<iframe
  src="ExtrasSubEquipe_01/Diagrama_de_Sequencia_V01.pdf"
  width="100%"
  height="700"
  style="border: none;">
</iframe>
...
[Diagrama de Sequência V1.0](ExtrasSubEquipe_01/Diagrama_de_Sequencia_V1.pdf)

<iframe
  src="ExtrasSubEquipe_01/Diagrama_de_Sequencia_V1.pdf"
  width="100%"
  height="700"
  style="border: none;">
</iframe>
...
Pedro Henrique Martins Silva | Adição do relatório sobre uso de IA genertiva(Foco 03)| 16/09
