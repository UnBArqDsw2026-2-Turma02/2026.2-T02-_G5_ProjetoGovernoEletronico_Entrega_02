...
| Pedro Henrique Martins Silva | Consolidação da modelagem dinâmica final do Diagrama de Sequência v1.0 |
...
| Luiz Henrique Pallavicini | O esforço cognitivo principal na arquitetura UML deve ser manual. O tempo economizado ao não focar na sintaxe de documentação pode ser redirecionado para elevar a qualidade técnica das modelagens. | Utilizei IA Generativa estritamente como assistente de redação (*pair writing*) na estruturação do Markdown, revisão textual e padronização de commits, sem permitir interferência na lógica da arquitetura de software. |
